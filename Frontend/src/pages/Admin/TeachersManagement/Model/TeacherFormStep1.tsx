...
import { User, MapPin, CreditCard, Loader2, Check, AlertCircle, Mail, Phone } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 transition-colors text-right ${
