...
const FormSection = memo<FormSectionProps>(({ title, icon, bgColor, children }) => (
...
const InputField = memo<InputFieldProps>(({ label, icon, required, children }) => (
  <div>
...
export const ExamFormModal = memo<ExamFormModalProps>(({
    ...
    if (open) {
      if (mode === 'edit' && initialData) {
        setFormData({
          ...
          passingMarks: initialData.passingMarks || DEFAULT_VALUES.passingMarks,
        });
  ...
  const updateFormField = useCallback(<K extends keyof ExamFormData>(
    field: K,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              <input
                ...
                onChange={(e) => updateFormField('totalMarks', parseInt(e.target.value) || 100)}
                disabled={isSubmitting}
                title="مجموع الدرجات"
              />
            </InputField>
            ...
            >
              <input
                ...
                onChange={(e) => updateFormField('passingMarks', parseInt(e.target.value) || 50)}
                disabled={isSubmitting}
                title="درجة النجاح"
              />
            </InputField>
