...
interface AddExamModalProps {
  open: boolean;
  onClose: () => void;
  onSubmit: (examData: { name: string; date: string; time: string }, selectedGroup: string) => Promise<void>;
  role: string;
...
export const AddExamModal = ({
  ...
  const [selectedGroupForExam, setSelectedGroupForExam] = useState(getDefaultGroup());
