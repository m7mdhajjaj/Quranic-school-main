...
import { 
  ...
  FaUsers, FaChalkboardTeacher, FaChartBar, FaTh, FaList, FaCalendar
} from 'react-icons/fa';
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-6">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-4 border border-blue-200">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-blue-600 font-medium mb-1">إجمالي الحلقات</p>
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-4 border border-green-200">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-green-600 font-medium mb-1">الحلقات النشطة</p>
                  <p className="text-3xl font-bold text-green-700">{stats.active}</p>
                </div>
                <FaChartBar className="w-10 h-10 text-green-400" />
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-4 border border-purple-200">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-purple-600 font-medium mb-1">إجمالي السعة</p>
                  <p className="text-3xl font-bold text-purple-700">{stats.totalCapacity}</p>
                </div>
                <FaUsers className="w-10 h-10 text-purple-400" />
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl p-4 border border-orange-200">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-orange-600 font-medium mb-1">عدد المعلمين</p>
                  <p className="text-3xl font-bold text-orange-700">{stats.teachers}</p>
                </div>
                <FaChalkboardTeacher className="w-10 h-10 text-orange-400" />
              </div>
            </div>
          </div>
        </div>
