      ...
      <div className="flex items-start gap-3 sm:gap-4">
        ...
        <Badge 
          ...
          className={`flex-shrink-0 !w-9 !h-9 sm:!w-10 sm:!h-10 !rounded-full flex items-center justify-center shadow-md transition-all duration-300 ${
            isCurrentAyah && isPlaying ? "scale-110 ring-2 ring-emerald-400 ring-offset-2" : "group-hover:scale-110"
          }`}>
          {ayah.numberInSurah}
        </Badge>
        
        {/* نص الآية */}
        <div className={`leading-loose sm:leading-relaxed font-amiri ${fontSizeClass} flex-1`}>
