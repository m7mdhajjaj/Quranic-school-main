      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        {loading ? (
          <div className="space-y-5">
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-lg border border-gray-100 animate-pulse">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                            <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-xl px-3 py-2">
                              ...
                              <div className="min-w-0 flex-1">
                                <p className="text-xs opacity-75 mb-0.5">الحلقة</p>
                                <p className="text-sm font-medium truncate">{warning.groupId?.name}</p>
                              </div>
                            </div>
                            ...
                            <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-xl px-3 py-2">
                              ...
                              <div className="min-w-0 flex-1">
                                <p className="text-xs opacity-75 mb-0.5">المعلم</p>
                                <p className="text-sm font-medium truncate">
                                  {warning.teacherId?.firstName} {warning.teacherId?.lastName}
                                </p>
                              </div>
                            </div>
                            ...
                            <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-xl px-3 py-2">
                              ...
                              <div className="min-w-0 flex-1">
                                <p className="text-xs opacity-75 mb-0.5">التاريخ</p>
                                <p className="text-sm font-medium truncate">
