...
export const AddActivityModal: React.FC<AddActivityModalProps> = ({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="إضافة نشاط جديد">
      {/* Gradient Header */}
      <div className="bg-gradient-to-r from-emerald-500 to-teal-600 p-6 -mt-6 -mx-6 mb-6">
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-xl font-bold text-white">إضافة نشاط جديد</h3>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-6">
          <ImageUpload
            label="صورة النشاط"
            currentImage={imagePreview || activity.image}
            onImageSelect={(file) => {
              const event = {
                target: {
                  files: [file],
