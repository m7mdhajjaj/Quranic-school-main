  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg border border-emerald-100 overflow-hidden w-full" dir="rtl">
      ...
      <div className="bg-gradient-to-l from-emerald-600 to-emerald-500 px-4 py-3">
        <h3 className="text-lg font-bold text-white text-center">الجدول الأسبوعي</h3>
      </div>
            ...
            <thead>
              <tr>
                ...
                {WEEK_DAYS.map((day) => (
                  <th
                    key={day}
                    className="bg-gradient-to-br from-emerald-50 to-emerald-100 border-b-2 border-l border-emerald-200 p-4 text-base font-bold text-emerald-900 shadow-sm">
                    {day}
                  </th>
                ))}
              </tr>
