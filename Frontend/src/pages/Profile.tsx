...
const Profile: React.FC = () => {
  ...
  useEffect(() => {
    ...
    fetch(`${API_URL}/users/${parsed._id}`)
      .then(res => res.json())
      .then(data => {
        setUser(data);
        setAvatarPreview(data.avatar ? `${API_URL}/uploads/${data.avatar}` : undefined);
      })
          ...
          <div className="w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="flex flex-col bg-emerald-50 rounded-xl px-6 py-4 shadow">
                ...
                <span className="text-gray-800 text-lg">{user.nationalId || '---'}</span>
              </div>
            </div>
            <div className="mt-8 flex flex-col md:flex-row gap-4 justify-center md:justify-end">
