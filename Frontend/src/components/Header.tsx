...
const Header = () => {
  ...
  const mainNavItems = [
    { to: '/', label: 'الرئيسية', icon: 'M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z' },
    { to: '/news', label: 'الأخبار', icon: 'M2 5a2 2 0 012-2h8a2 2 0 012 2v10a2 2 0 002 2H4a2 2 0 01-2-2V5zm3 1h6v4H5V6zm6 6H5v2h6v-2z' },
    { to: '/goals', label: 'الأهداف', icon: 'M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z' },
    { to: '/daily-marks', label: 'العلامات اليومية', icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z', stroke: true },
    { to: '/test', label: 'الاختبارات', icon: 'M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01', stroke: true },
    { to: '/exam-schedule', label: 'جدول الامتحانات', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z', stroke: true },
    { to: '/prayer-times', label: 'مواقيت الصلاة', icon: 'M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z', stroke: true }
  ];

  const secondaryNavItems = [
    { to: '/quran', label: 'القرآن الكريم', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253', stroke: true },
    { to: '/quran-audio', label: 'القرآن الصوتي', icon: 'M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M9 9v6l6-3-6-3z', stroke: true },
    { to: '/arrangement', label: 'الترتيب', icon: 'M7 11.5V14m0-2.5v-6a1.5 1.5 0 113 0m-3 6a1.5 1.5 0 00-3 0v2a7.5 7.5 0 0015 0v-5a1.5 1.5 0 00-3 0m-6-3V11m0-5.5v-1a1.5 1.5 0 113 0v1m0 0V11m0-5.5a1.5 1.5 0 113 0v3m-3-3a1.5 1.5 0 113 0v3m-3-3a1.5 1.5 0 113 0v3', stroke: true },
    { to: '/activities', label: 'الأنشطة', icon: 'M19 11H5m14-7H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2V6a2 2 0 00-2-2zM9 10h6m-6 4h6m-6 4h6', stroke: true },
    { to: '/absence', label: 'الحضور والغياب', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z', stroke: true },
    { to: '/reports', label: 'التقارير', icon: 'M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', stroke: true },
    { to: '/chat', label: 'تواصل مع المعلم', icon: 'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z', stroke: true },
    ...(isTeacherOrAdmin ? [{ to: '/managment', label: 'الإدارة', icon: 'M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065zm4.675 7.683a3 3 0 11-6 0 3 3 0 016 0z', stroke: true }] : []),
    { to: '/timetable', label: 'جدول الحصص', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z', stroke: true }
  ];

  // Component Renderers
  const renderIcon = (icon: string, stroke = false) => (
    <svg className="w-5 h-5" fill={stroke ? "none" : "currentColor"} stroke={stroke ? "currentColor" : undefined} viewBox="0 0 24 24">
      <path 
  ...
  return (
    <>
      {/* Main Header */}
      <header className="sticky top-0 z-50 bg-gradient-to-r from-emerald-600 to-teal-500 text-white shadow-lg" dir="rtl">
                  ...
                  <div className="absolute right-0 top-full mt-3 w-72 bg-white/95 backdrop-blur-lg rounded-xl shadow-2xl border border-gray-100/80 py-2 z-[100]">
                    ...
                    >
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 7a2 2 0 012 2m0 0a2 2 0 012 2m-2-2a2 2 0 00-2 2m2-2a2 2 0 002-2M9 5a2 2 0 00-2 2v6a2 2 0 002 2h6a2 2 0 002-2V7a2 2 0 00-2-2H9z" />
                      </svg>
                      تغيير كلمة المرور
                    </button>
            ...
            <div className="flex items-center justify-center flex-1">
              <div className="flex items-center gap-3">
                <img
                  ...
                  alt="مدرسة القرآن"
                  className="cursor-pointer h-8 w-8 lg:h-10 lg:w-10 rounded-full border-2 border-white shadow-lg transition-transform hover:scale-105"
                />
                <div className="text-center">
                  <h1 className="text-sm lg:text-base font-bold text-white leading-tight">
                    أكاديمية مدرسة المهاجرين
                  </h1>
                  <p className="text-xs lg:text-sm text-white/90 leading-tight">
        ...
        <div className="hidden lg:block border-t border-white/10">
          <div className="container mx-auto px-4 lg:px-6">
            <nav className="py-0.5">
              <div className="rounded-2xl bg-white/5 backdrop-blur-md py-1.5 px-3 shadow-xl border border-white/10">
                <div className="flex flex-col gap-2">
                  <ul className="flex flex-wrap justify-center gap-2 text-base font-medium" dir="rtl">
      ...
      {/* Mobile Navigation */}
      {isMenuOpen && (
        <div className="fixed inset-0 bg-black/50 z-[55] lg:hidden" onClick={toggleMenu}>
          <div
          ...
          >
            ...
            <div className="p-4">
              <nav className="space-y-2">
                {[...mainNavItems, ...secondaryNavItems].map(renderMobileNavLink)}
              </nav>
