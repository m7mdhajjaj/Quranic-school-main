...
const Header = () => {
  ...
  const ImageSkeleton = ({
    ...
    <div
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="flex gap-1">
          <div
            className="w-1 h-1 bg-gray-500/80 rounded-full animate-bounce"
  ...
  return (
    <>
      <header
        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8">
          <div className="flex justify-between items-center h-14 sm:h-16 md:h-18 lg:h-20">
            <Link
              to="/"
              className="flex items-center gap-1 sm:gap-2 md:gap-3 lg:gap-4 hover:opacity-90 transition-opacity duration-200 group">
              <div
                className={`relative w-8 h-8 xs:w-9 xs:h-9 sm:w-10 sm:h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 rounded-lg sm:rounded-xl md:rounded-2xl flex items-center justify-center shadow-lg sm:shadow-xl transition-all duration-500 transform hover:scale-110 hover:rotate-6 ${
                  scrolled
                ...
                {!logoLoaded && (
                  <ImageSkeleton
                    className="w-5 h-5 xs:w-6 xs:h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 lg:w-10 lg:h-10 rounded-full absolute"
                    variant="logo"
                  />
                )}
                <img
              ...
              <div className="header-text min-w-0 flex-1">
                <h1
                  className={`text-xs xs:text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl font-bold transition-colors duration-500 leading-tight truncate ${
                    scrolled
                ...
                <p
                  className={`text-xs xs:text-xs sm:text-sm md:text-sm transition-colors duration-500 leading-tight truncate ${
                    scrolled ? "text-gray-600" : "text-white/90"
                  }`}>
                  أكاديمية مدرسة الهجرة للقرآن الكريم
                </p>
                ...
                <NavLink
                  ...
                  {({ isActive }) => (
                    <>
                      ...
                      {isActive && (
                        <span
                          className={`absolute bottom-0 left-0 right-0 h-1 rounded-t-lg bg-gradient-to-r ${item.gradient} animate-slide-in`}></span>
                      )}
                    </>
                  )}
                </NavLink>
            ...
            <div className="flex items-center gap-1 sm:gap-2 md:gap-3">
              ...
              {currentUser && (
                <div
                  className={`p-1 xs:p-1.5 sm:p-2 md:p-2.5 rounded-lg md:rounded-xl transition-all duration-300 transform hover:scale-110 ${
                    scrolled
              ...
              <div className="relative" ref={profileMenuRef}>
                <button
                  ...
                  <div
                    className={`w-5 h-5 xs:w-6 xs:h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 rounded-full flex items-center justify-center font-bold text-xs xs:text-xs sm:text-sm ${
                      scrolled
                  ...
                  <svg
                    className={`w-3 h-3 xs:w-3.5 xs:h-3.5 sm:w-4 sm:h-4 transition-transform duration-300 hidden xs:block ${
          ...
          <div
            className={`hidden lg:flex items-center justify-between border-t pt-3 pb-3 ${
              scrolled ? "border-gray-200" : "border-white/20"
            }`}>
            <div className="flex-1">
              <div
                className={`rounded-2xl px-6 py-2.5 border ${
                  scrolled
      ...
      <div className="h-40 sm:h-44 md:h-48 lg:h-52"></div>
