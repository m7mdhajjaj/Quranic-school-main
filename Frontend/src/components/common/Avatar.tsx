...
const Avatar: React.FC<AvatarProps> = React.memo(({
  ...
  if (loading) {
    return (
      <div className={`${sizeClasses[size]} rounded-full ${borderClasses[border]} flex items-center justify-center ${getGenderColor()}`}>
  ...
  const AvatarContent = () => (
    <div className={`relative group ${className}`}>
      ...
      {showStatus && (
        <Tooltip content={getStatusTitle()} position="top">
          <div
            className={`
              absolute 
