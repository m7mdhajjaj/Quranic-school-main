...
const EmptyState: React.FC<{
  ...
  return (
    <tr>
      <td
        colSpan={columns}
        className="px-3 py-6 sm:px-4 sm:py-8 md:px-6 md:py-12 text-center">
        <div className="flex flex-col items-center justify-center gap-2 sm:gap-3">
          <div className="text-3xl sm:text-4xl md:text-6xl opacity-30">
            {icon}
          </div>
...
export const Table = <T,>({
  ...
  const containerClasses = ["overflow-x-auto", className]
    .filter(Boolean)
    .join(" ");
    ...
    <div className={containerClasses}>
      <div
        ...
        <table className={tableClasses}>
          ...
          {/* Table Body */}
          <tbody
            className={`divide-y ${headerClassName ? "divide-emerald-100/50" : "divide-gray-100"} bg-white`}>
            {loading ? (
              <tr>
                <td
                  colSpan={totalColumns}
                  className="px-3 py-6 sm:px-4 sm:py-8">
