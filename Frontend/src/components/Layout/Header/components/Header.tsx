...
const Header: React.FC<HeaderProps> = ({ className = '' }) => {
  ...
  return (
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-[100] bg-gradient-to-br from-emerald-600 via-emerald-500 to-teal-600 shadow-xl backdrop-blur-xl border-b border-white/20 ${className}`}
        dir="rtl"
      >
