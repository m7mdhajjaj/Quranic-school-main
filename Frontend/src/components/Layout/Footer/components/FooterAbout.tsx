  ...
  return (
    <div className={`space-y-2.5 sm:space-y-3 ${className}`}>
      ...
      <div className="flex items-center gap-2 sm:gap-3 mb-2">
        <div className="w-10 h-10 sm:w-11 sm:h-11 lg:w-12 lg:h-12 bg-white/60 backdrop-blur-md rounded-xl flex items-center justify-center animate-bounce-slow border border-emerald-200 shadow-sm">
