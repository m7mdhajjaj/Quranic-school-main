...
import { getChartSizes, formatMarkValue } from "./utils";
...
const MarksBarChart = ({
  ...
  // استخدام utility functions للحصول على الأحجام الـ responsive
