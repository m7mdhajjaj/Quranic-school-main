...
const firebaseConfig = {
  apiKey:
    ...
    "AIzaSyAPCYf7HCTQ3DiW_PFwxTKBeHFp3EN5Qn4",
  authDomain:
    import.meta.env.VITE_FIREBASE_AUTH_DOMAIN ||
    "quranic-school-main.firebaseapp.com",
  projectId: import.meta.env.VITE_FIREBASE_PROJECT_ID || "quranic-school-main",
  storageBucket:
    import.meta.env.VITE_FIREBASE_STORAGE_BUCKET ||
    "quranic-school-main.firebasestorage.app",
  messagingSenderId:
    import.meta.env.VITE_FIREBASE_MESSAGING_SENDER_ID || "570702964068",
  appId:
    import.meta.env.VITE_FIREBASE_APP_ID ||
    "1:570702964068:web:64bb6b980db932cc3f8671",
...
const VAPID_KEY =
  ...
  "BL8lvVEg7bHx9Z7dm5HjS5TXImbL7HsDstJG-7istQ-FmafDheIdJsVkcRpucUiA6msThVR4nUXvG1pqyZQGCf8";

if (!VAPID_KEY || VAPID_KEY === "") {
  console.warn(
    "⚠️ VITE_FIREBASE_VAPID_KEY is missing. Push notifications may fail. Generate a key pair in Firebase Console > Project Settings > Cloud Messaging > Web Push certificates.",
  );
}
