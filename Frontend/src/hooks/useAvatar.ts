...
/**
 * دالة مساعدة للحصول على الجنس من بيانات المستخدم
 */
export function getUserGender(user: { gender?: string } | null | undefined): 'male' | 'female' | 'ذكر' | 'أنثى' {
...
/**
 * دالة مساعدة للحصول على اسم المستخدم للـ fallback
 */
export function getUserDisplayName(user: { firstName?: string; name?: string } | null | undefined): string {
