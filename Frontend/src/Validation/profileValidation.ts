// Profile Validation - يستخدم الـ validation من ملفات المستخدمين المختلفة حسب الـ role
 ...
 */
export const validateProfileData = async (data: ProfileData, isUpdate: boolean = true): Promise<{ 
  isValid: boolean; 
  errors: FieldErrors 
}> => {
 ...
 */
export const isProfileDataValid = async (data: ProfileData): Promise<boolean> => {
...
// Export types
export type { TeacherFormData, StudentFormData, AdminFormData };
