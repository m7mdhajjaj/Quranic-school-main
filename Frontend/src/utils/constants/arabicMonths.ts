...
/**
 * أسماء الأشهر بالتنسيق العربي (array للاستخدام في Attendance)
 */
export const AR_MONTHS = ARABIC_MONTHS.map((m) => m.label);
...
/**
 * الحصول على قائمة بخيارات الأشهر لـ Picker Component
 */
 ...
 */
export const MONTH_NAMES = ARABIC_MONTHS.map((m) => m.label);

/**
 * أسماء الأشهر الكاملة بالعربية
 */
export const MONTH_FULL_NAMES = ARABIC_MONTHS.map((m) => m.fullLabel);
