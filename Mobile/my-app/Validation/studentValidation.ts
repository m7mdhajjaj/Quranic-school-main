// Student Validation using Yup - Mobile
...
export const studentValidationSchema = yup
  .object({
    ...
    residence: yup.string().nullable().trim(),

    teacher: yup.string().nullable().notRequired().trim(),
