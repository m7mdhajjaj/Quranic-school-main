// ============================================================================
// AssistantsStatsCards - بطاقات إحصائيات مساعدي المدرسين
// ============================================================================

import React from "react";
import { View, Text, ActivityIndicator } from "react-native";
import type { TeacherAssistantStats } from "@/Api/teacherAssistantApi";
...
export const AssistantsStatsCards: React.FC<AssistantsStatsCardsProps> = ({
  stats,
  loading,
}) => {
  const statsData = [
