/**
 * دوال مساعدة للتعامل مع التواريخ في React Native
 */

/**
 * تحويل التاريخ إلى صيغة yyyy-mm-dd للاستخدام في DatePicker
 ...
 */
export const formatDateTimeArabic = (
  date: Date | string | null | undefined
): string => {
  if (!date) return "غير محدد";
  try {
...
/**
 * توليد قائمة بالسنوات (للاستخدام في Picker)
...
/**
 * تحويل Date إلى ISO string للإرسال إلى API
 * @param date - التاريخ
 * @returns ISO string
 */
