...
const validateExamTitle = (title) => {
  ...
  if (titleStr.length < 3) {
    return {
      isValid: false,
      message: "عنوان الامتحان يجب أن يكون 3 أحرف على الأقل",
    };
  }
  ...
  if (titleStr.length > 200) {
    return {
      isValid: false,
      message: "عنوان الامتحان يجب أن يكون 200 حرف أو أقل",
    };
  }
...
const validateDescription = (description) => {
  ...
  if (descStr.length > 1000) {
    return {
      isValid: false,
      message: "وصف الامتحان يجب أن يكون 1000 حرف أو أقل",
    };
  }
...
const validateExamType = (type) => {
  ...
  if (!validTypes.includes(typeStr)) {
    return {
      isValid: false,
      message: "نوع الامتحان يجب أن يكون: شفهي، كتابي، أو تقييم شامل",
    };
  }
...
const validateExamDate = (date, isUpdate = false) => {
  ...
  if (examDateOnly < minDate) {
    return {
      isValid: false,
      message: "يجب أن يكون تاريخ الامتحان بعد يومين على الأقل من اليوم",
    };
  }
...
const validateExamTime = (time) => {
  ...
  if (hours < 12 || hours > 21) {
    return {
      isValid: false,
      message: "الوقت المسموح من 12:00 ظهراً إلى 9:00 مساءً",
    };
  }
...
const validateDuration = (duration) => {
  ...
  if (isNaN(durationNum) || durationNum < 5) {
    return {
      isValid: false,
      message: "مدة الامتحان يجب أن تكون 5 دقائق على الأقل",
    };
  }
  ...
  if (durationNum > 120) {
    ...
    return {
      isValid: false,
      message: "مدة الامتحان لا يمكن أن تزيد عن ساعتين (120 دقيقة)",
    };
  }
...
const validateTotalMarks = (totalMarks) => {
  ...
  if (isNaN(marksNum) || marksNum < 10) {
    return {
      isValid: false,
      message: "مجموع الدرجات يجب أن يكون 10 على الأقل",
    };
  }

  if (marksNum > 100) {
    return { isValid: false, message: "مجموع الدرجات لا يمكن أن يزيد عن 100" };
  }
...
const validatePassingMarks = (passingMarks, totalMarks = 20) => {
  ...
  if (passingNum > totalMarks) {
    return {
      isValid: false,
      message: "درجة النجاح لا يمكن أن تزيد عن مجموع الدرجات",
    };
  }
