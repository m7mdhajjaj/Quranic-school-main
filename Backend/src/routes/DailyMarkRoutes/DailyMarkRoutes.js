...
} = require("../../Validation/Group/ActiveGroupsValidation");
const {
  validateGroupStats,
} = require("../../Validation/DailyMark/GroupStatsValidation");
...
router.get(
  "/active-groups",
  validateActiveGroupsQuery,
  groupController.getActiveGroups,
);
...
router.get(
  ...
  validateGroupStats,
  dailyMarkController.getGroupStats,
);
...
router.get(
  ...
  dailyMarkController.getStudentMarkStats,
);
...
// ============================================================================
// PATCH ROUTES - توقيع/مشاهدة العلامة (الطالب فقط)
// ============================================================================

// Mark a specific mark as seen (signature)
// PATCH /api/daily-marks/:id/seen
router.patch("/:id/seen", dailyMarkController.markSeen);
...
router.put(
  ...
  teacherProtect,
  validateUpdateMark,
  dailyMarkController.updateMarkById,
);
...
router.put(
  ...
  teacherProtect,
  validateBulkUpdateMarks,
  dailyMarkController.updateMultipleMarks,
);
...
router.delete(
  ...
  teacherProtect,
  validateDeleteMark,
  dailyMarkController.deleteMark,
);
